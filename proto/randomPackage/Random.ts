...
import type { PingRespond as _randomPackage_PingRespond, PingRespond__Output as _randomPackage_PingRespond__Output } from '../randomPackage/PingRespond';
...
export interface RandomClient extends grpc.Client {
  ...
  PingPong(argument: _randomPackage_PingRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_randomPackage_PingRespond__Output>): grpc.ClientUnaryCall;
  PingPong(argument: _randomPackage_PingRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_randomPackage_PingRespond__Output>): grpc.ClientUnaryCall;
  PingPong(argument: _randomPackage_PingRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_randomPackage_PingRespond__Output>): grpc.ClientUnaryCall;
  PingPong(argument: _randomPackage_PingRequest, callback: grpc.requestCallback<_randomPackage_PingRespond__Output>): grpc.ClientUnaryCall;
  pingPong(argument: _randomPackage_PingRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_randomPackage_PingRespond__Output>): grpc.ClientUnaryCall;
  pingPong(argument: _randomPackage_PingRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_randomPackage_PingRespond__Output>): grpc.ClientUnaryCall;
  pingPong(argument: _randomPackage_PingRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_randomPackage_PingRespond__Output>): grpc.ClientUnaryCall;
  pingPong(argument: _randomPackage_PingRequest, callback: grpc.requestCallback<_randomPackage_PingRespond__Output>): grpc.ClientUnaryCall;
...
export interface RandomHandlers extends grpc.UntypedServiceImplementation {
  ...
  PingPong: grpc.handleUnaryCall<_randomPackage_PingRequest__Output, _randomPackage_PingRespond>;
...
export interface RandomDefinition extends grpc.ServiceDefinition {
  ...
  PingPong: MethodDefinition<_randomPackage_PingRequest, _randomPackage_PingRespond, _randomPackage_PingRequest__Output, _randomPackage_PingRespond__Output>
